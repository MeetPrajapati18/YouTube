  ...
  return (
    <main className="py-8 bg-gray-900 text-white min-h-screen">
      <div className="container mx-auto px-4">
        {/* Search Bar */}
        <form
          className="mb-6 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4"
        ...
        >
          ...
          <input
            ...
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder="Search for videos..."
            className="p-2 rounded bg-gray-800 text-white w-full md:flex-1 focus:outline-none focus:ring-2 focus:ring-purple-600"
          />

          {/* Search Button */}
          <button
            type="submit"
            className="px-4 py-2 rounded bg-purple-600 hover:bg-pink-400 text-white focus:outline-none w-full md:w-auto"
          >
            Search
          </button>
        </form>

  ...
  return (
    <main className="py-8 bg-gray-900 text-white min-h-screen">
      <div className="container text-center mx-auto">
        <h2 className="text-4xl py-4 font-bold text-gray-400">User's Videos</h2>
            ...
            videos.map((video) => (
              <div key={video._id} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  {/* First Div - For Edit, Publish/Unpublish, and Manage Comments */}
                  ...
                  {/* Second Div - For Delete Button */}
                  <div className="mt-4">
                    <button
                      onClick={() => handleDelete(video._id)}
                      className="inline-block bg-red-600 hover:bg-red-700 text-white w-full px-4 py-3 rounded-md text-sm font-medium"
                    >
                      Delete Video
                    </button>
                  </div>
        ...
        {/* Tweets section */}
        <h2 className="text-4xl text-center py-4 font-bold text-gray-400">User's Tweets</h2>
